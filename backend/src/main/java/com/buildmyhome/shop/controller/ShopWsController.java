...
public class ShopWsController {
  ...
  public void startShop(ShopMessage message, Principal principal) {
    ...
    try {
      ...
      GameMessage response = createShopResponse("SHOP_STARTED", gameState, memberId);
  ...
  public void buyItem(ShopMessage message, Principal principal) {
    ...
    try {
      ...
      GameMessage response = createShopResponse("ITEM_PURCHASED", gameState, memberId);
      simpMessagingTemplate.convertAndSend("/topic/games/" + roomId, response);
    } catch (Exception e) {
      sendErrorMessage(roomId, memberId, e.getMessage());
    }
  ...
  public void buyResource(ShopMessage message, Principal principal) {
    ...
    try {
      ...
      GameMessage response = createShopResponse("RESOURCE_PURCHASED", gameState, memberId);
      simpMessagingTemplate.convertAndSend("/topic/games/" + roomId, response);
    } catch (Exception e) {
      sendErrorMessage(roomId, memberId, e.getMessage());
    }
  ...
  public void sellResource(ShopMessage message, Principal principal) {
    ...
    try {
      ...
      GameMessage response = createShopResponse("RESOURCE_SOLD", gameState, memberId);
      simpMessagingTemplate.convertAndSend("/topic/games/" + roomId, response);
    } catch (Exception e) {
      sendErrorMessage(roomId, memberId, e.getMessage());
    }
  ...
  public void sellHarvest(ShopMessage message, Principal principal) {
    ...
    try {
      ...
      GameMessage response = createShopResponse("HARVEST_SOLD", gameState, memberId);
      simpMessagingTemplate.convertAndSend("/topic/games/" + roomId, response);
    } catch (Exception e) {
      sendErrorMessage(roomId, memberId, e.getMessage());
    }
  ...
  public void endShop(ShopMessage message, Principal principal) {
    ...
    try {
      ...
      GameMessage response = createShopResponse("SHOP_ENDED", gameState, memberId);
      simpMessagingTemplate.convertAndSend("/topic/games/" + roomId, response);
    } catch (Exception e) {
      sendErrorMessage(roomId, memberId, e.getMessage());
    }
  ...
  /* Helper: GameMessage 생성 */
  private GameMessage createShopResponse(String type, GameState gameState, Long memberId) {
