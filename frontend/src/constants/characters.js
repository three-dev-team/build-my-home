...
export const CHARACTERS = [
  ...
  makeCharacter({ id: 5, name: "쭈니", quote: "훗, 나란 녀석은 어쩔 수 없군", key: "zzuni", color: "#F9F3F9" }),
  makeCharacter({ id: 6, name: "시베리아", quote: "무슨 일이지? 바쁜데", key: "cida", color: "#34C4D3" }),
  makeCharacter({ id: 7, name: "리처드", quote: "물놀이 하러 갈래?", key: "richard", color: "#F2C94C" }),
  makeCharacter({ id: 8, name: "뽀야미", quote: "눈송이처럼 하얗고 싶어요", key: "bboyami", color: "#FDFBF6" }),
];
