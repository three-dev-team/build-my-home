  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50">
      <div className="bg-[#FDFBF6] rounded-[1.5cqw] p-[2cqw] w-[30cqw] text-center shadow-xl">
        ...
        {/* 메시지 */}
        <p className="text-[1cqw] text-[#7B6C53] mb-[2cqh]">{message}</p>
        ...
        <div className="flex gap-[1cqw]">
          ...
          <button
            onClick={onConfirm}
            className="flex-1 bg-[#EB5757] text-white py-[0.8cqh] rounded-[0.8cqw] text-[1cqw] font-bold hover:bg-[#D04545] transition-colors"
          >
            확인
          </button>
        </div>
