        ...
        <div className="fixed inset-0 z-[9999] bg-black/60 flex items-center justify-center backdrop-blur-sm">
            ...
            >
                ...
                <div className="text-center mb-10">
                    <h1 className={`text-4xl sm:text-5xl font-black ${TONE.brownText} drop-shadow-sm mb-4`}>
                        🎉 게임 종료 🎉
                    </h1>
                    <p className={`text-lg font-bold ${TONE.brownText2}`}>
                        드디어 꿈꾸던 마이홈이 완성되었습니다!
                    </p>
                </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className={[
                                    ...
                                    isWinner ? "bg-white border-[#e6c200] text-[#e6c200]" : "bg-[#efe2c8] border-[#d6b98a] text-[#8a6e57]"
                                ].join(" ")}>
                                    {player.rank}위
                                </div>
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2">
                                        <div className={`text-lg sm:text-xl font-black truncate ${TONE.brownText}`}>
                                            {player.nickname} 
                                            {isMe && <span className="text-xs ml-2 px-2 py-0.5 rounded-full bg-[#7bb46b] text-white">나</span>}
                                        </div>
                                    </div>
                                ...
                                {isWinner && (
                                    <div className="absolute -top-4 -right-2 text-4xl animate-bounce">
                                        👑
                                    </div>
                                )}
                            </div>
                ...
                <div className="mt-12 text-center">
                    <p className="text-[#8a6e57] font-bold mb-4 animate-pulse">
                        {timeLeft}초 후 자동으로 나가지게 됩니다...
                    </p>
                    <button
                        onClick={() => {
                            onLeave(); // [Explicit Leave]
