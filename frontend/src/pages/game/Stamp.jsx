            ...
            {step === 0 && (
                <div className="relative bg-[#FFF8DC] rounded-3xl p-12 max-w-xl text-center shadow-2xl">
                    ...
                    <p className="text-2xl leading-relaxed">
                        {currentPlayerName} 반가워!<br />
                        {config.name}에 온 걸 환영해<br />
                        방문카드를 주면 스탬프를 찍어줄게!
                    </p>
                ...
                <div className="bg-[#FFF8DC] rounded-3xl p-12 max-w-2xl text-center shadow-2xl">
                        ...
                        {Object.entries(STAMP_CONFIG).map(([type, cfg]) => {
                            ...
                            return (
                                <div key={type} className="relative z-10 flex flex-col items-center gap-4">
                                    ...
                                    >
                                        {isCollected ? (
                                            <div className={`w-full h-full flex items-center justify-center ${isJustStamped ? "animate-stamp-slam" : ""}`}>
                                                <img
                                                    src={cfg.image}
                                                    alt={cfg.name}
                                                    className="w-full h-full object-contain drop-shadow-xl"
                    ...
                    {isDuplicate ? (
                        <div className="bg-yellow-50 rounded-xl p-6 mb-6">
                            <p className="text-xl">
                                어라라.. 이미 찍혀있네..<br />
                                아쉬우니까 <span className="font-bold text-yellow-600">{DUPLICATE_REWARD}벨</span>이라도 받아가!<br />
                                다음에 또 만나~
                            </p>
                        </div>
                    ) : (
