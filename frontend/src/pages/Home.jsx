...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (audioRef.current) {
      ...
      const initialVolume =
        savedVolume !== null ? parseFloat(savedVolume) : 0.4;
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div
        className={`absolute top-6 right-10 z-20 flex gap-8 items-start ${uiTransitionClass}`}
      >
        {/* 유저(마이페이지) 버튼 */}
        <Link
