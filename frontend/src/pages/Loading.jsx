...
export default function Loading() {
  ...
  return (
    <div className="relative w-full h-screen bg-[#f8f1e7] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative w-80 bg-[#fdf6e3] p-6 rounded-[40px] border-[6px] border-[#8b5a2b] shadow-2xl z-20">
        {/* 상단 헤더 */}
        ...
        <div className="space-y-5">
          ...
          {/* 인원 설정 표시 */}
          <div className="bg-[#efe7d1] p-3 rounded-2xl border-2 border-[#a67c52]/10 flex justify-between items-center">
