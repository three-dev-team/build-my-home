...
export default function UserInquiryPage() {
    ...
    const fetchMyInquiries = async (currentCursor, size = 5) => { // 기본 5개씩
        try {
            setLoading(true);
        ...
        <div className="min-h-screen bg-gradient-to-b from-[#a8d5ba] to-[#e8f5e9] p-4">
            ...
            <div className="max-w-4xl mx-auto mb-4">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-4 border-4 border-[#8b5a2b]">
                    <h1 className="text-2xl font-black text-[#5d4037] mb-1">
                        📮 문의하기
                    </h1>
            ...
            {activeTab === "write" && (
                <div className="max-w-4xl mx-auto">
                    <div className="bg-white rounded-2xl shadow-lg p-6 border-4 border-[#8b5a2b]">
                        {/* 카테고리 선택 */}
                        <div className="mb-4">
                            <label className="block text-base font-bold text-[#5d4037] mb-2">
                                카테고리 선택
                            </label>
                                ...
                                {myInquiries.map((inquiry) => (
                                    ...
                                    >
                                        <div className="flex justify-between items-start mb-2">
                                            <h3 className="text-base font-bold text-[#5d4037] flex-1">
                                                {inquiry.title}
                                            </h3>
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex justify-between items-start mb-6">
                                <div className="flex-1">
                                    ...
                                    <h2 className="text-2xl font-black text-[#5d4037] mt-3">
